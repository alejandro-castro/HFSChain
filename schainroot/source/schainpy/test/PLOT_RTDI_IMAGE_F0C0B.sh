...
python RTDI_OUT_HF.py -path /home/hfuser/HFB -C 0 -ii 6 -f 2.72216796875 -code 0 -lo 12 -ch 0 # modo normal
echo "IMAGE_F0C0CH1 ORIENTACION N45O"
#python RTDI_OUT_HF.py -path /home/hfuser1204/HFA -f 2.72 -code 0 -lo 32 -ch 1#modocampaign
python RTDI_OUT_HF.py -path /home/hfuser/HFB -C 0 -ii 6 -f 2.72216796875 -code 0 -lo 12 -ch 1 # modo normal
