...
opObj11.addParameter(name='wintitle', value='HF_Jicamarca_Phase_F0C0', format='str')
...
opObj11.addParameter(name='wintitle', value='HF_Jicamarca_Coh_F0C0', format='str')
opObj11.addParameter(name='show', value='0', format='bool')
...
opObj21.addParameter(name='wintitle', value='Doppler-Radial Velocity Plot0 F0C0', format='str')
...
opObj21.addParameter(name='wintitle', value='SNR_0 F0C0', format='str')
opObj21.addParameter(name='channelList', value='0', format='intlist') 
opObj21.addParameter(name='show', value='0', format='bool')
...
opObj21.addParameter(name='wintitle', value='SNR_1 F0C0', format='str')
