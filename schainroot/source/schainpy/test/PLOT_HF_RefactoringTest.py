...
figpath="/home/ci-81/Documents/JRO_CAMPAIGN_ALEJANDRO/Refactor/sp"+str(code)+'1_f'+str(ngraph)+'/'#'/home/ci-81/Documents/TestDopler/Figures/sp'+str(code)+'1_f'+str(ngraph)+'/'
...
opObj25.addParameter(name='dataList',value='data_param,data_SNR,data_RGB,CrossData,utctime,location',format='list')#AvgCohModuledata_DC,data_Coherence
...
# opObj31.addParameter(name='showMeanDoppler', value='0', format='bool')
