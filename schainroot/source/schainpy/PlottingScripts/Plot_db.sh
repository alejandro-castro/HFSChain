...
echo "HFA0_C1"
python PlotParam.py  -path $1 -f 2.72216796875  -C 0 -ii 6 -online 0 -code 1 -lo $2  -date "2019/03/23"
...
#echo "HFA1_C0"
#pythonPlotParam.py  -path $1 -f 3.64990234375 -C 0 -ii 6 -online 0 -code 0 -lo $2
