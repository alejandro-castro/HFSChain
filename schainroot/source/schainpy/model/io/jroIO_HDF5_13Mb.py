...
#         grp.attrs['blocksPerFile'] = 0
        ...
        for i in range(len(self.dataList)):
            ...
            if nDims[i]==1:
                ...
                ds0_aux=numpy.zeros((20),dtype = "c")
    ...
    def writeBlock(self):
        ...
        for i in range(len(self.ds_aux)):
            print 'i is each dataset put in ds dictionary:',i # i
            print 'self.data[i].shape:',self.data[i].shape
    ...
    def writeBlockF(self):
        ...
        #raw_input("before put one minute of data...cancel")
        for i in range(len(self.ds_aux)):
            print 'EXTRA: i is each dataset put in ds dictionary:',i # i
            print 'EXTRA: self.data[i].shape:',self.data[i].shape
            self.ds[i].resize(self.data[i].shape)#Prepare the dataset to put the data
            self.ds[i][...] = self.ds_aux[i] # put the data
